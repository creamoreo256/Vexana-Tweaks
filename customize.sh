...
ui_print "    2. Force idle(more free ram)"
ui_print ""
ui_print "    Select:"
D=1
while true; do
...
ui_print "    Selected: $D"
case $D in
    1 ) TEXT4="Default"; sed -i '/#dozemode/s/.*/doze_default/' $MODPATH/service.sh;;
    2 ) TEXT4="Force idle"; sed -i '/#dozemode/s/.*/force_idle/' $MODPATH/service.sh;;
esac
ui_print "    $TEXT4"
ui_print ""
...
ui_print "  8) Deepsleep enhancer         : $TEXT4"
